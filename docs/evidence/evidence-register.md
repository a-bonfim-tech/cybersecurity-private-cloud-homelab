...
| WAZUH-EXEC-001 | EXECUTED_SYNTHETIC_TEST_EVIDENCE | Native rule test | `docs/evidence/executions/wazuh/` | Actual Suricata alert decoded and evaluated by Wazuh 4.14.7; the exact executed rule is retained as `local_rules-WAZUH-EXEC-001.xml`. | Rule 100010 level 7 and T1046 matched; later rule 100002 hardening is not part of this execution claim |
